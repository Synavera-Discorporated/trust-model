...
Revision History:
  - 2026-01-07 COD  Release-only version bump to v1.0.2; content unchanged from v1.0.1.
...
### v1.0.2 — Release Bump (2026-01-07)

Classification: Release-only bump (no content changes)

This release corrects the immutable release tag without altering the document.
Content is identical to v1.0.1.
